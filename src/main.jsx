...
ReactDOM.createRoot(document.getElementById('root')).render(<React.StrictMode><HelmetProvider><BrowserRouter basename={routerBase}><AppProvider><App/><Toaster position="bottom-center"/></AppProvider></BrowserRouter></HelmetProvider></React.StrictMode>)
